const Home = () => {
    return (
        <div>
            <div className="flex">
                <form className="ml-60 mt-40 w-1/4">
                    <h1 className="font-black text-3xl">Find Pet doc in your city</h1>
                ...
                <img src="https://st3.depositphotos.com/12530034/35781/v/380/depositphotos_357811116-stock-illustration-coloring-pages-black-white-cute.jpg?forcejpeg=true" className="ml-80 w-1/4  h-1/5 rounded-full" alt="" />
            </div>
        </div>
    )
} 
